...
export const colors = {
    ...
    uygulamaRengi:'#1DA1F2', // buton arka planı için, ayırt edici textler için, uyarı textler için, uyarı border rengi için kullanılır, sayfada kullanılan ayırt edici icon için.
    uygulamaRengiDisabled:'#A3D0F7',
